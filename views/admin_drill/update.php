    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select name="actual_stage_id" id="actual_stage_id" class="form-control">
                    <?php foreach ($actualStageList as $actualStageItem): ?>
                        <option value="<?=$actualStageItem['id']?>" <?= $actualStageItem['id'] == $drill['actual_stage_id'] ? 'selected' : ''?>>
            ...
            <div class="form-group">
                ...
                <input type="date" name="date_actual_stage_refresh" value="<?=$drill['date_actual_stage_refresh']?>" class="form-control" id="date_actual_stage_refresh">
            </div>
            <div class="form-group">
