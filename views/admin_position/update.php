...
<div class="row">
    <div class="col text-center">
        <h1>Редагувати інформацію про посаду</h1>
        <br/>
    </div>
</div>
<div class="row justify-content-center">
    <div class="col-sm-6">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <select name="organization_id" class="form-control" id="organization_id">
                    <?php foreach ($organizations as $organization): ?>
                        <option value="<?=$organization['id']?>" <?=$organization['id'] == $position['organization_id'] ? 'selected': '' ?>><?=$organization['name']?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="division_id" class="form-control" id="division_id">
                    ...
                    <?php foreach ($divisions as $division): ?>
                        <option value="<?=$division['id']?>" <?=$division['id'] == $position['division_id'] ? 'selected': '' ?>><?=$division['name']?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="submit" name="submit" value="Зберегти" role="button" class="btn btn-warning">
            </div>
        </form>
    </div>
</div>
